...
import (
	...
	"github.com/izi-global/izi/cmd/commands/api"
...
var CmdHproseapp = &commands.Command{
	...
	Short:     "Creates an RPC application based on Hprose and IZIGo frameworks",
	Long: `
  The command 'hprose' creates an RPC application based on both IZIGo and Hprose (http://hprose.com/).

  {{"To scaffold out your application, use:"|bold}}

      $ izi hprose [appname] [-tables=""] [-driver=mysql] [-conn=root:@tcp(127.0.0.1:3306)/test]
...
func createhprose(cmd *commands.Command, args []string) int {
	...
	iziLogger.Log.Info("Creating Hprose application...")
	...
	iziLogger.Log.Success("New Hprose application successfully created!")
	return 0
}
